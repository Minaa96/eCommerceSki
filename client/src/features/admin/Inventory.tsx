...
import { productsSelectors, fetchProizvodiAsync, fetchFilters, setPageNumber, removeProduct } from "../catalog/catalogSlice";
                            ...
                            >
                                ...
                                <TableCell align="left">
                                    <Box display='flex' alignItems='center'>
                                        <img src={product.pictureUrl} alt={product.ime} style={{ height: 50, marginRight: 20 }} />
                                        <span>{product.ime}</span>
                                    </Box>
                                </TableCell>
                                <TableCell align="right">{currencyFormat(product.cena)}</TableCell>
                                <TableCell align="center">{product.tip}</TableCell>
                                <TableCell align="center">{product.brend}</TableCell>
